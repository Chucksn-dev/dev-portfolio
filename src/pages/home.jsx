            ...
            <div className="about-content flex text-center  sm:justify-center flex-wrap xl:flex-nowrap w-full sm:text-justify">
              ...
              <div className="about-text px-4 lg:px-8 mb-4 sm:text-xl font-medium">
                <span className="block">
                  Hi, my name is Chucks and I'm a frontend developer. With over
                  2 years of programming experience, I have a passion for
                  creating high-quality, user-friendly and responsive, web and
                  mobile applications . As a quick learner and problem-solver, I
                  am constantly seeking new challenges to improve my skills and
